    ...
    def generate_maze(self):
        if len(self.to_be_selected) > 0:
            ...
            for i in range(len(self.run_x)):
                ...
                if 0 < nxt_point.x < self.row-1 and 0 < nxt_point.y < self.col-1 and (self.maze[nxt_point.x][nxt_point.y] == 1 or self.maze[nxt_point.x][nxt_point.y] == 3) and self.isVisited[nxt_point.x][nxt_point.y] == False:
